...
![](output/boxplot_raw_probe_gc.png)
...
Se aplicó **normalización por cuantiles**, para hacer comparables las distribuciones de intensidades entre arrays.

---
### 3c. Filtrado por detección (modificado a 25% en todos los grupos)
...
## 3d. Modelo estadístico y permutaciones
...
![](output/P-values_Hist.png)

La desviación respecto a la uniformidad (picos hacia 0) indica la presencia de señales biológicas reales.

---

# 3e. Resultados de expresión diferencial (FDR ≤ 0.19)

Resultados extraídos del archivo **DE_results.csv**
...
# 3f. Análisis de los genes con interacción
...
Ejemplos del archivo GO_BP_Table.csv:
...
- **Script modificado:** [Tutorial_DE_tarea.R](Tutorial_DE_tarea.R)
- **Archivo de datos (5000 sondas):** [Illum_data_sample_tarea.txt](Illum_data_sample_tarea.txt)
- **Archivo de anotaciones (5000 sondas):** [MouseRef-8_annot_tarea.txt](MouseRef-8_annot_tarea.txt)
